		        ...
		        children:[
					...
					{text:'Loans',iconCls:'menuItemIcon',expanded:false
						,children:[
							...
							//jdj 09112017 - added to display 5% breakdown menu
							,{text:'5% HSP Subsidy Report',leaf:true,iconCls:'menuItemIcon',activatepanel:'pnl5percent'}
					...
					{text:'Capital Contribution',iconCls:'menuItemIcon',expanded:false
						,children:[
							...
							,{text:'NWC',leaf:true,iconCls:'menuItemIcon',activatepanel:'pnlNWC'}
						]	
					}
	...
	,reportsCardBody: function(){
		return {
			...
			,items:[
				...
				// jdj 09112017 - added to display p&g 5% breakdown
				,{xtype:'panel',id:'pnl5percent',title:'5% Subsidy Report',width:1100
					//[END] Modified by Vincent Sy for 8th Enhancement 2013/07/03
						//,html:'<div class="placeholder">Under construction</div>'
						,layout: 'border', defaults: {autoScroll: true}
						,items: [rpt_5percent()]
				...
				,{xtype:'panel',id:'pnlNWC',title:'Non Withdrawable Capital (NWC)',width:1100
					//,html:'<div class="placeholder">Under construction</div>'
					,layout: 'border', defaults: {autoScroll: true}
					,items: [rpt_nwc()]
				}
