		        ...
		        children:[
					...
					{text:'Loans',iconCls:'menuItemIcon',expanded:false
						,children:[
							...
							,{text:'Loans Payments for Company Share',leaf:true,iconCls:'menuItemIcon',activatepanel:'pnlsubsidy'}
							...
							,{text:'Mini Loan Penalty Report',leaf:true,iconCls:'menuItemIcon',activatepanel:'pnlpenalty'}	
							,{text:'Mini Loan of Suspended Borrowers Report',leaf:true,iconCls:'menuItemIcon',activatepanel:'pnlsuspendedborrowers'}	
	...
	,reportsCardBody: function(){
		return {
			...
			,items:[
				...
				,{xtype:'panel',id:'pnlsubsidy',title:'Loans Payments for Company Share',width:1100
					//,html:'<div class="placeholder">Under construction</div>'
					,layout: 'border', defaults: {autoScroll: true}
					,items: [rpt_subsidy()]
				}
				...
				,{xtype:'panel',id:'pnlpenalty',title:'Mini Loan Penalty Report',width:1100
					//,html:'<div class="placeholder">Under construction</div>'
					,layout: 'border', defaults: {autoScroll: true}
					,items: [rpt_penalty()]
				}
				...
				,{xtype:'panel',id:'pnlsuspendedborrowers',title:'Mini Loan of Suspended Borrowers',width:1100
					//,html:'<div class="placeholder">Under construction</div>'
					,layout: 'border', defaults: {autoScroll: true}
					,items: [rpt_suspended()]
				}
