// created by jdj 09112017
// screen for report generation of 5% hsp sub breakdown

var rpt_5percent = function(){
	return{
		xtype:'form'
		,id:'rpt_5percent'
		,region: 'center'
		...
		,buttons:[{
		    ...
		    ,handler : function(btn){
				var frm = Ext.getCmp('rpt_5percent').getForm();
		    	if(frm.isValid()){
		    		try {
		    		...
		    		Ext.Ajax.request({
						...
						,params: {'file_type': Ext.getCmp('rpt_5percent').getForm().getValues().file_type
									,'month': Ext.getCmp('rpt_5percent').getForm().getValues().month
									,'year': Ext.getCmp('rpt_5percent').getForm().getValues().year
									,auth:_AUTH_KEY}
						,isUpload: true
