	...
	return{
		...
		,buttons:[{
		    ...
		    ,handler : function(btn){
				var frm = Ext.getCmp('rpt_loancode').getForm();
		    	if(frm.isValid()){
		    		try {
		    		...
		    		Ext.Ajax.request({
						...
						,params: {file_type: Ext.getCmp('rpt_loancode').getForm().getValues().file_type
			        				,auth:_AUTH_KEY}
						,isUpload: true
