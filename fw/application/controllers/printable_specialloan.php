...
/* Location: ./CodeIgniter/application/controllers/printable_specialloan.php */

class Printable_specialloan extends Asi_Controller 
{
	function Printable_specialloan() 
	{
	...
	function index() {	
		$_REQUEST['is_admin'] = '1';
		 ...
		 if($data){
			 set_time_limit(0);
			 $filename = "ALLSpecialLoan_".date("YmdHis");		
			 ...
			 $html = $this->load->view('forms/special', $data, true);
